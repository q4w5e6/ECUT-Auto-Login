## 感谢[Heisenberglue](https://github.com/q4w5e6/ECUT-Auto-Login/issues/2)提供的方案，现在直接PPPoE拨号方式，用户名栏填 学号@运营商后缀（电信是telecom，移动是cmcc，联通是unicom，校园网则无） , 密码栏填校园网的密码就可以实现拨号
